...
In this part we use a multiple regression analysis to analyse how points is affected by gender, age and attitude. The results show that only attitude have a significant statistic impact on the points from the exam. Age and gender does not play a part in the results. Our model has an adjusted R-square value of 0.187, indicating that the chosen model explains 18.7 % of the variance shown in the dependent variable, points. In other words, the chosen explanatory variables are not that good. The residual standard error of the model is 5.315 on 162 degrees of freedom.
